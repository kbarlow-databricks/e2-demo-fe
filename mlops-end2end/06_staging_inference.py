...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=local&notebook=%2F06_staging_inference&demo_name=mlops-end2end&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F06_staging_inference&version=1">
...
# MAGIC %run ./_resources/00-setup $reset_all_data=false $catalog="kbarlow"
...
# MAGIC * [Explore DBSQL Churn Dashboard](/sql/dashboards/90a7f63c-1e18-4898-825f-c406b644bcec-churn-prediction-dashboard---universal?o=1444828305810485#)
