...
# MAGIC To run this demo, just select the cluster `dbdemos-mlops-end2end-kevin_barlow` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0213-223043-vapiq61s/configuration)). <br />
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-science&org_id=local&notebook=%2F00_mlops_end2end_presentation&demo_name=mlops-end2end&event=VIEW&path=%2F_dbdemos%2Fdata-science%2Fmlops-end2end%2F00_mlops_end2end_presentation&version=1">
...
# MAGIC %run ./_resources/00-setup $reset_all_data=$reset_all_data $catalog="kbarlow"
...
# MAGIC
# MAGIC Ultimately, we will be able to build a [complete DBSQL Churn Dashboard](/sql/dashboards/90a7f63c-1e18-4898-825f-c406b644bcec-churn-prediction-dashboard---universal?o=1444828305810485#) containing all our customer & churn information!
