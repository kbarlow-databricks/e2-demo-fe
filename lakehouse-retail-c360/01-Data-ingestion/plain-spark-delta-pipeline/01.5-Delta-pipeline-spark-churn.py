...
# MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-retail-c360-kevin_barlow` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0219-083836-i686c32l/configuration)). <br />
...
# MAGIC %sql 
# MAGIC LIST '/Volumes/kbarlow/c360/c360/users'

# COMMAND ----------

# DBTITLE 1,Review the raw user data received as JSON
# MAGIC %sql
# MAGIC SELECT * FROM json.`/Volumes/kbarlow/c360/c360/users`
