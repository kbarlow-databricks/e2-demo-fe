...
# MAGIC %md
# MAGIC A workflow was created as part of this demo. Open the <a dbdemos-workflow-id="init-job" href="#job/556579432160506/tasks" target="_blank">IOT Wind Turbine Workflow</a> to start exploring Databricks orchestration capabilities!
