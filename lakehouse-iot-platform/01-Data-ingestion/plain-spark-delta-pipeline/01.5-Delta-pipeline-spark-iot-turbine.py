...
# MAGIC %sql LIST '/Volumes/kbarlow/iot/turbine_raw_landing/incoming_data'

# COMMAND ----------

# DBTITLE 1,Review the raw sensor data received as JSON
# MAGIC %sql
# MAGIC SELECT * FROM PARQUET.`/Volumes/kbarlow/iot/turbine_raw_landing/incoming_data`
...
#                                                                 Model name         |        
#                                                                     |              |        
predict_maintenance = mlflow.pyfunc.spark_udf(spark, "models:/kbarlow.iot.dbdemos_turbine_maintenance@prod", "string") #, env_manager='virtualenv'
