...
# MAGIC %sql
# MAGIC create database if not exists kbarlow.loans;
# MAGIC use kbarlow.loans;
...
# MAGIC %sql
# MAGIC alter table kbarlow.loans.dlt_expectations set tblproperties (delta.autoOptimize.optimizeWrite = true, delta.autoOptimize.autoCompact = true)
