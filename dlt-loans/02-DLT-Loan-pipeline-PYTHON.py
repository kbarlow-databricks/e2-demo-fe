...
# MAGIC
# MAGIC **Your DLT Pipeline is ready!** Your pipeline was started using the SQL notebook and is <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/fdac834f-a5c6-46bd-ae07-269ef5938f8d">available here</a>.
# MAGIC
# MAGIC <!-- Collect usage data (view). Remove it to disable collection. View README for more details.  -->
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=data-engineering&org_id=1444828305810485&notebook=%2F02-DLT-Loan-pipeline-PYTHON&demo_name=dlt-loans&event=VIEW&path=%2F_dbdemos%2Fdata-engineering%2Fdlt-loans%2F02-DLT-Loan-pipeline-PYTHON&version=1">
...
# MAGIC %md ## Next steps
# MAGIC
# MAGIC Your DLT pipeline is ready to be started. <a dbdemos-pipeline-id="dlt-loans" href="/#joblist/pipelines/fdac834f-a5c6-46bd-ae07-269ef5938f8d">Click here to access the pipeline</a> created for you using the SQL notebook.
# MAGIC
...
# MAGIC
# MAGIC <a href="/sql/dashboards/2328cdcd-1fe8-49b6-9214-16d0d250c2a6" target="_blank">Data Quality Dashboard example</a>
