...
-- MAGIC To run this demo, just select the cluster `dbdemos-dlt-loans-kevin_barlow` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0215-200711-uzadq335/configuration)). <br />
...
-- MAGIC %md
-- MAGIC Your expectations are ready to be queried in SQL! Open the <a href="/sql/dashboards/2328cdcd-1fe8-49b6-9214-16d0d250c2a6" target="_blank">data Quality Dashboard example</a> for more details.
