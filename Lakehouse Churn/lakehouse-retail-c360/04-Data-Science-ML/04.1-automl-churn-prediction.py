...
# MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-retail-c360-kevin_barlow` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0802-224102-awus71gg/configuration)). <br />
...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F04-Data-Science-ML%2F04.1-automl-churn-prediction&cid=1444828305810485&uid=8986687027577729">

# COMMAND ----------

# MAGIC %run ../_resources/02-create-churn-tables $reset_all_data=false $catalog="kbarlow" $db=""
...
# MAGIC
# MAGIC <a href='/sql/dashboards/acb4f78a-22b7-4d69-a247-59beca6f7bb5'>Open the Churn prediction DBSQL dashboard</a> | [Go back to the introduction]($../00-churn-introduction-lakehouse)
# MAGIC
