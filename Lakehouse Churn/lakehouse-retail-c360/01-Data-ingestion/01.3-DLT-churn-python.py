...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F01-Data-ingestion%2F01.3-DLT-churn-python&cid=1444828305810485&uid=8986687027577729">
...
# MAGIC %md
# MAGIC Your DLT Pipeline has been installed and started for you! Open the <a dbdemos-pipeline-id="dlt-churn" href="#joblist/pipelines/fb9b0312-558c-4ebc-b6c1-08ba4cc68bae" target="_blank">Churn Delta Live Table pipeline</a> to see it in action.<br/>
...
@dlt.table(comment="Application events and sessions")
...
@dlt.table(comment="Order data cleaned and anonymized for analysis.")
...
@dlt.table(comment="Customer at risk of churn")
...
# MAGIC
# MAGIC Open the <a dbdemos-pipeline-id="dlt-churn" href="#joblist/pipelines/fb9b0312-558c-4ebc-b6c1-08ba4cc68bae" target="_blank">Churn Delta Live Table pipeline</a> and click on start to visualize your lineage and consume the new data incrementally!
...
# MAGIC
# MAGIC <a href="/sql/dashboards/a1854dfc-6b63-4f94-bb54-fb0cf57a13a1-dlt---retail-data-quality-stats" target="_blank">Data Quality Dashboard</a>
...
# MAGIC
# MAGIC <a href="/sql/dashboards/acb4f78a-22b7-4d69-a247-59beca6f7bb5" target="_blank">Open the DBSQL Dashboard</a>