...
# MAGIC <img width="1px" src="https://www.google-analytics.com/collect?v=1&gtm=GTM-NKQ8TT7&tid=UA-163989034-1&aip=1&t=event&ec=dbdemos&ea=VIEW&dp=%2F_dbdemos%2Flakehouse%2Flakehouse-retail-c360%2F01-Data-ingestion%2Fplain-spark-delta-pipeline%2F01.5-Delta-pipeline-spark-churn&cid=1444828305810485&uid=8986687027577729">
...
# MAGIC
# MAGIC
# MAGIC Switch to Databricks SQL to see how this data can easily be requested using <a href='/sql/dashboards/acb4f78a-22b7-4d69-a247-59beca6f7bb5' target="_blank">Churn prediction DBSQL dashboard</a>, or an external BI tool. 
# MAGIC
